...
namespace Resdata.Bindings.Generated {
    public static class Native_rd_type {
        ...
        public static extern IntPtr rd_type_create(IntPtr rd_type_enum, IntPtr size_t);
        [DllImport(LIB, CallingConvention = CallingConvention.Cdecl )]
        ...
        public static void ExecuteAll() {
            ...
            try { var r = rd_type_create_from_name(null); Console.WriteLine("rd_type_create_from_name -> " + r); } catch(Exception ex) { Console.WriteLine("rd_type_create_from_name threw: " + ex.Message); }
